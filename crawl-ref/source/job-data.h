...
{ JOB_AIR_ELEMENTALIST, {
    ...
    { "robe", "book of Air", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
    { { SK_AIR_MAGIC, 4 },
...
{ JOB_ARCANE_MARKSMAN, {
    ...
    { "robe", "book of Arcane Marksmanship", "scroll of amnesia" },
    WCHOICE_RANGED,
...
{ JOB_EARTH_ELEMENTALIST, {
    ...
    { SP_DEEP_ELF, SP_SPRIGGAN, SP_GARGOYLE, SP_VINE_STALKER,
      SP_OCTOPODE, },
    { "book of Geomancy", "robe", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
...
{ JOB_ENCHANTER, {
    ...
    { "dagger plus:1", "robe plus:1", "book of Maledictions", "scroll of amnesia" },
    WCHOICE_NONE,
...
{ JOB_FIRE_ELEMENTALIST, {
    ...
    { "robe", "book of Flames", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
    { { SK_FIRE_MAGIC, 4 },
      { SK_DODGING, 2 }, { SK_STEALTH, 2 }, },
} },
...
{ JOB_ICE_ELEMENTALIST, {
    ...
    { SP_DEEP_ELF, SP_MERFOLK, SP_NAGA, SP_BASE_DRACONIAN, SP_TITAN,
      SP_GARGOYLE, },
    { "robe", "book of Frost", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
    { { SK_ICE_MAGIC, 4 },
      { SK_DODGING, 2 }, { SK_STEALTH, 2 }, },
} },
...
{ JOB_NECROMANCER, {
    ...
    { SP_DEEP_ELF, SP_MOUNTAIN_DWARF, SP_DEMONSPAWN, SP_MUMMY,
      SP_VAMPIRE, },
    { "robe", "book of Necromancy", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
...
{ JOB_SKALD, {
    ...
    { "leather armour", "book of Battle", "scroll of amnesia" },
    WCHOICE_PLAIN,
...
{ JOB_SUMMONER, {
    ...
    { SP_DEEP_ELF, SP_MOUNTAIN_DWARF, SP_VINE_STALKER, SP_MERFOLK, SP_TENGU,
      SP_VAMPIRE, },
    { "robe", "book of Callings", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
...
{ JOB_TRANSMUTER, {
    ...
    { SP_NAGA, SP_MERFOLK, SP_BASE_DRACONIAN, SP_TITAN, SP_DEMONSPAWN,
      SP_TROLL, },
    { "robe", "book of Changes", "scroll of amnesia" },
    WCHOICE_NONE,
...
{ JOB_WIZARD, {
    ...
    { SP_DEEP_ELF, SP_NAGA, SP_BASE_DRACONIAN, SP_OCTOPODE, SP_HUMAN,
      SP_MUMMY, },
    { "robe", "hat", "book of Minor Magic", "scroll of amnesia", "dagger" },
    WCHOICE_NONE,
    { { SK_DODGING, 2 }, { SK_STEALTH, 2 },
