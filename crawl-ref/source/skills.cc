...
vector<skill_type> get_crosstrain_skills(skill_type sk)
{
    ...
    {
    case SK_FIGHTING:
        return {SK_ARMOUR,SK_DODGING,SK_STEALTH,SK_SHIELDS,SK_SPELLCASTING};
    case SK_SHORT_BLADES:
        return {SK_HEXES,SK_LONG_BLADES,SK_AXES,SK_MACES_FLAILS,SK_POLEARMS,SK_STAVES,SK_UNARMED_COMBAT};
    case SK_LONG_BLADES:
        return {SK_ICE_MAGIC,SK_SHORT_BLADES,SK_AXES,SK_MACES_FLAILS,SK_POLEARMS,SK_STAVES,SK_UNARMED_COMBAT};
    case SK_AXES:
        return {SK_FIRE_MAGIC,SK_SHORT_BLADES,SK_LONG_BLADES,SK_MACES_FLAILS,SK_POLEARMS,SK_STAVES,SK_UNARMED_COMBAT};
    case SK_MACES_FLAILS:
        return {SK_EARTH_MAGIC,SK_SHORT_BLADES,SK_LONG_BLADES,SK_AXES,SK_POLEARMS,SK_STAVES,SK_UNARMED_COMBAT};
    case SK_POLEARMS:
        return {SK_AIR_MAGIC,SK_SHORT_BLADES,SK_LONG_BLADES,SK_AXES,SK_MACES_FLAILS,SK_STAVES,SK_UNARMED_COMBAT};
    case SK_STAVES:
        return {SK_POISON_MAGIC,SK_SHORT_BLADES,SK_LONG_BLADES,SK_AXES,SK_MACES_FLAILS,SK_POLEARMS,SK_UNARMED_COMBAT};
    case SK_SLINGS:
        return {SK_BOWS,SK_CROSSBOWS,SK_THROWING};
    case SK_BOWS:
        return {SK_CROSSBOWS,SK_THROWING,SK_SLINGS};
    case SK_CROSSBOWS:
        return {SK_BOWS,SK_THROWING,SK_SLINGS};
    case SK_THROWING:
        return {SK_BOWS,SK_CROSSBOWS,SK_SLINGS};
    case SK_ARMOUR:
        return {SK_FIGHTING,SK_DODGING,SK_STEALTH,SK_SHIELDS,SK_SPELLCASTING};
    case SK_DODGING:
        return {SK_FIGHTING,SK_ARMOUR,SK_STEALTH,SK_SHIELDS,SK_SPELLCASTING};
    case SK_STEALTH:
        return {SK_FIGHTING,SK_ARMOUR,SK_DODGING,SK_SHIELDS,SK_SPELLCASTING};
    case SK_SHIELDS:
        return {SK_FIGHTING,SK_ARMOUR,SK_DODGING,SK_STEALTH,SK_SPELLCASTING};
    case SK_UNARMED_COMBAT:
        return {SK_TRANSMUTATIONS,SK_SHORT_BLADES,SK_LONG_BLADES,SK_AXES,SK_MACES_FLAILS,SK_POLEARMS,SK_STAVES};
    case SK_SPELLCASTING:
        return {SK_FIGHTING,SK_ARMOUR,SK_DODGING,SK_STEALTH,SK_SHIELDS};
    case SK_CONJURATIONS:
        return {SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_HEXES:
        return {SK_SHORT_BLADES,SK_CONJURATIONS,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_CHARMS:
        return {SK_CONJURATIONS,SK_HEXES,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_SUMMONINGS:
        return {SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_NECROMANCY:
        return {SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_TRANSLOCATIONS:
        return {SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_TRANSMUTATIONS:
        return {SK_UNARMED_COMBAT,SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_FIRE_MAGIC:
        return {SK_AXES,SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_ICE_MAGIC:
        return {SK_LONG_BLADES,SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_AIR_MAGIC:
        return {SK_POLEARMS,SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_EARTH_MAGIC,SK_POISON_MAGIC};
    case SK_EARTH_MAGIC:
        return {SK_MACES_FLAILS,SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_POISON_MAGIC};
    case SK_POISON_MAGIC:
        return {SK_STAVES,SK_CONJURATIONS,SK_HEXES,SK_CHARMS,SK_SUMMONINGS,SK_NECROMANCY,SK_TRANSLOCATIONS,SK_TRANSMUTATIONS,SK_FIRE_MAGIC,SK_ICE_MAGIC,SK_AIR_MAGIC,SK_EARTH_MAGIC};
    case SK_INVOCATIONS:
