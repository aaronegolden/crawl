...
{   // Base draconian.
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 320,
    8, 8, MST_NO_SPELLS, CE_CLEAN, S_ROAR, I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 300,
    8, 8, MST_NO_SPELLS, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_TAIL_SLAP, AF_POISON, 15}, AT_NO_ATK,
       AT_NO_ATK },
    9, 300,
    8, 8, MST_NO_SPELLS, CE_NOXIOUS, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...
// Nonbase draconian AC and EV is additive with the base type.
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 275,
    -1, -1, MST_DRACONIAN_STORMCALLER, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    11, 400,
    -3, 0, MST_NO_SPELLS, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 250,
    -2, -2, MST_DRACONIAN_SHIFTER, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 225,
    -2, -3, MST_ANNIHILATOR, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    11, 305,
    1, 2, MST_DRACONIAN_KNIGHT, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 225,
    -2, -4, MST_DRACONIAN_SCORCHER, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 250,
    7, 7, MST_KILLER_KLOWN, CE_CLEAN, S_SHOUT,
...

{
    ...
    13, 320,
    8, 8, MST_DRAIN_GAZE, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    9, 160,
    0, 7, MST_MOTH_OF_WRATH, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 390,
    11, 1, MST_CURSE_TOE, CE_NOCORPSE, S_MOAN,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK },
    12, 460,
...

{
    ...
    12, 400,
    4, 4, MST_FIRE_GIANT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 24}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 460,
    4, 3, MST_FROST_GIANT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 600,
    5, 2, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 620,
    6, 3, MST_TITAN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 24}, {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK },
    15, 700,
    3, 7, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 13}, {AT_TRAMPLE, AF_TRAMPLE, 13}, AT_NO_ATK, AT_NO_ATK },
    9, 400,
    6, 7, MST_FIRE_DRAGON_BREATH, CE_CLEAN, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    9, 400,
    6, 7, MST_ICE_DRAGON_BREATH, CE_CLEAN, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 13}, {AT_TRAMPLE, AF_TRAMPLE, 13},
      AT_NO_ATK, AT_NO_ATK },
    9, 350,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 14}, {AT_CLAW, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK },
    9, 375,
    7, 5, MST_QUICKSILVER_DRAGON, CE_CLEAN, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 13}, {AT_TRAMPLE, AF_TRAMPLE, 13}, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    3, 8, MST_SPLINTER_BREATH, CE_CLEAN, S_LOUD_ROAR,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 13}, {AT_TRAMPLE, AF_TRAMPLE, 13},
      AT_NO_ATK, AT_NO_ATK },
    10, 500,
    3, 8, MST_STORM_DRAGON, CE_CLEAN, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 13}, {AT_TRAMPLE, AF_TRAMPLE, 13},
      AT_NO_ATK, AT_NO_ATK },
    10, 500,
    5, 9, MST_GOLDEN_DRAGON, CE_NOXIOUS, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_BITE, AF_DRAIN_XP, 20}, {AT_TRAMPLE, AF_TRAMPLE, 13},
      AT_NO_ATK, AT_NO_ATK },
    10, 500,
    9, 5, MST_SHADOW_DRAGON, CE_NOXIOUS, S_SILENT, // stealth dragon
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, {AT_TRAMPLE, AF_TRAMPLE, 15},
      AT_NO_ATK, AT_NO_ATK },
    10, 300,
...

{
    ...
    { {AT_BITE, AF_HOLY, 15}, {AT_CLAW, AF_HOLY, 15}, AT_NO_ATK, AT_NO_ATK },
    10, 450,
    8, 8, MST_PEARL_DRAGON, CE_CLEAN, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_TOUCH, AF_DRAIN_XP, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 315,
    5, 12, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK },
    9, 325,
    4, 4, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_ELEC, 10}, {AT_HIT, AF_ELEC, 10}, {AT_HIT, AF_PLAIN, 10},
      AT_NO_ATK },
    8, 280,
    5, 7, MST_ELECTRIC_GOLEM, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 320,
    6, 12, MST_ORB_OF_FIRE, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
...
// other symbols
{
    ...
    { {AT_HIT, AF_DRAIN_SPEED, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 120,
    7, 4, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 25, DEFAULT_ENERGY,
