...

{
    ...
    SPTYP_TRANSLOCATION,
    SPFLAG_TARGET | SPFLAG_OBJ | SPFLAG_NOT_SELF | SPFLAG_MONSTER,
    1,
    1000,
    LOS_RADIUS, LOS_RADIUS,
    1, 0,
...
#endif
{
    ...
    SPFLAG_NO_GHOST | SPFLAG_NEUTRAL,
    3,
    100,
    -1, -1,
    3, 2,
...

{
    SPELL_SLOW, "Slow",
    SPTYP_HEXES,
    SPFLAG_DIR_OR_TARGET | SPFLAG_NEEDS_TRACER | SPFLAG_MR_CHECK | SPFLAG_MONSTER,
    2,
    200,
    LOS_RADIUS, LOS_RADIUS,
    2, 0,
...
{
    SPELL_ESSENCE_SPRAY, "Essence Spray",
    SPTYP_NECROMANCY,
    SPFLAG_MR_CHECK,
    1,
    25,
...

{
    ...
    SPTYP_SUMMONING,
    SPFLAG_UNHOLY | SPFLAG_SELFENCH | SPFLAG_MONS_ABJURE | SPFLAG_MONSTER,
    7,
    200,
    -1, -1,
    6, 0,
...

{
    ...
    SPTYP_TRANSMUTATION | SPTYP_NECROMANCY,
    SPFLAG_HELPFUL | SPFLAG_CORPSE_VIOLATING | SPFLAG_CHAOTIC | SPFLAG_MONSTER,
    6,
    200,
    -1, -1,
    6, 0,
...

{
    ...
    SPTYP_FIRE | SPTYP_TRANSMUTATION,
    SPFLAG_NO_GHOST | SPFLAG_CHAOTIC,
    5,
    200,
    LOS_RADIUS, LOS_RADIUS,
    5, 0,
...
{
    SPELL_THROW_BOULDER, "Throw Large Rock",
    SPTYP_EARTH,
    SPFLAG_DIR_OR_TARGET | SPFLAG_NEEDS_TRACER | SPFLAG_MONSTER,
    6,
    200,
