...
#define DRAGON_ARMOUR(id, name, ac, evp, prc, res, acq)                     \
	...
	{ ARM_ ## id ## _DRAGON_ARMOUR, name " dragon scales",  ac, evp, prc,   \
      EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false, res, acq }
#else
#define DRAGON_ARMOUR(id, name, ac, evp, prc, res, acq)                          \
    { ARM_ ## id ## _DRAGON_ARMOUR, name " dragon scales",  ac, evp, prc,   \
      EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false, res, acq }
...
static const armour_def Armour_prop[] =
{
    { ARM_ANIMAL_SKIN,          "animal skin",            2,   0,     3,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, true, ARMF_NO_FLAGS, 0 },
    { ARM_ROBE,                 "robe",                   2,   0,     7,
...
const set<pair<object_class_type, int> > removed_items =
{
    ...
    { OBJ_JEWELLERY, RING_LIFE_PROTECTION },
    { OBJ_JEWELLERY, RING_RESIST_CORROSION },
    { OBJ_JEWELLERY, RING_POISON_RESISTANCE },
